 ...
 *
 *
 * The GPS receiver measurements includes: satellite PRN, accumulated delta range in meters,
...
open class GpsMeasurement(
    ...
    protected constructor(another: GpsMeasurement) : this(another.arrivalTimeSinceGpsWeekNs, another.accumulatedDeltaRangeMeters,
