 ...
 *
 *
 * The container extends [GpsMeasurement] to additionally include
 * [.pseudorangeMeters] and [.pseudorangeUncertaintyMeters].
 */
class GpsMeasurementWithRangeAndUncertainty(another: GpsMeasurement,
                                            /** Pseudorange measurement (meters)  */
                                            val pseudorangeMeters: Double,
                                            /** Pseudorange uncertainty (meters)  */
                                            val pseudorangeUncertaintyMeters: Double) : GpsMeasurement(another)