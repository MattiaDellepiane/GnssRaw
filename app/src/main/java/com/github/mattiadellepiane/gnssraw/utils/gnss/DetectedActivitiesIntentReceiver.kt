...
/**
 * A [BroadcastReceiver] that receives and broadcasts the result of
 * [ #ActivityRecognitionApi#requestActivityUpdates()][com.google.android.gms.location.ActivityRecognition]
 * to {link MainActivity} to be further analyzed.
 */
class DetectedActivitiesIntentReceiver : BroadcastReceiver() {
    /**
     * Gets called when the result of [ #ActivityRecognitionApi#requestActivityUpdates()][com.google.android.gms.location.ActivityRecognition] is available and handles
     * incoming intents.
     *
     * @param intent The Intent is provided (inside a [android.app.PendingIntent])
     * when [         #ActivityRecognitionApi#requestActivityUpdates()][com.google.android.gms.location.ActivityRecognition] is called.
     */
    override fun onReceive(context: Context, intent: Intent) {
        intent.action = AR_RESULT_BROADCAST_ACTION
        LocalBroadcastManager.getInstance(context).sendBroadcast(intent)
    }

    companion object {
        var AR_RESULT_BROADCAST_ACTION = "com.google.android.apps.location.gps.gnsslogger.AR_RESULT_BROADCAST_ACTION"
    }
}